...
class netlink : public IOUserNetworkEthernet {
    OSDeclareDefaultStructors(netlink);    // Constructor & Destructor stuff
...
private:
    ...
    IOUserNetworkEthernet *fNetworkInterface;
...
class netlinkInterface : public IOUserNetworkEthernet {
    OSDeclareDefaultStructors(netlinkInterface);
    int maxmtu;
public:
